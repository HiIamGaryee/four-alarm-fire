  ...
  useEffect(() => {
    try {
      ...
      if (stored) {
        ...
        setData({
          creditScore: parsed.creditworthinessScore || 0,
          incomeMonthly: parsed.customer?.incomeMonthly || 0,
          debtsMonthly: parsed.customer?.debtsMonthly || 0,
          utilization: parsed.customer?.utilization || 0,
          monthlySpending: parsed.monthlySpending || [],
          rentPayments: parsed.rentPayments || [],
        });
      }
    } catch {
      // ignore error, stay default
    }
  }, []);
